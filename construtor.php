...
class Conta
{
    ...
    function __construct(string $cpf, string $nome) //inicializa (os atributos de) instância/ objeto automaticamente pelo new. Código que é inicializado sempre que cria uma nova conta.
    {
